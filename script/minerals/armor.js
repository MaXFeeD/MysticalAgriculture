...
Item.createArmorItem("inferium_helmet", "Inferium Helmet", { name: "inferium_helmet", meta: 0 }, { type: "helmet", armor: 4, durability: 440, texture: "armor/inferium_layer_0.png" });
MysticalRecipes.addGemstoneUpgrade(ItemID.inferium_helmet, VanillaItemID.diamond_helmet, ItemID.inferium_gemstone, ItemID.inferium_ingot);

IDRegistry.genItemID("inferium_chestplate");
Item.createArmorItem("inferium_chestplate", "Inferium Chestplate", { name: "inferium_chestplate", meta: 0 }, { type: "chestplate", armor: 8, durability: 640, texture: "armor/inferium_layer_0.png" });
MysticalRecipes.addGemstoneUpgrade(ItemID.inferium_chestplate, VanillaItemID.diamond_chestplate, ItemID.inferium_gemstone, ItemID.inferium_ingot);

IDRegistry.genItemID("inferium_leggings");
Item.createArmorItem("inferium_leggings", "Inferium Leggings", { name: "inferium_leggings", meta: 0 }, { type: "leggings", armor: 6, durability: 600, texture: "armor/inferium_layer_1.png" });
MysticalRecipes.addGemstoneUpgrade(ItemID.inferium_leggings, VanillaItemID.diamond_leggings, ItemID.inferium_gemstone, ItemID.inferium_ingot);

IDRegistry.genItemID("inferium_boots");
Item.createArmorItem("inferium_boots", "Inferium Boots", { name: "inferium_boots", meta: 0 }, { type: "boots", armor: 3, durability: 520, texture: "armor/inferium_layer_0.png" });
MysticalRecipes.addGemstoneUpgrade(ItemID.inferium_boots, VanillaItemID.diamond_boots, ItemID.inferium_gemstone, ItemID.inferium_ingot);


IDRegistry.genItemID("prudentium_helmet");
Item.createArmorItem("prudentium_helmet", "Prudentium Helmet", { name: "prudentium_helmet", meta: 0 }, { type: "helmet", armor: 4, durability: 660, texture: "armor/prudentium_layer_0.png" });
MysticalRecipes.addGemstoneUpgrade(ItemID.prudentium_helmet, ItemID.inferium_helmet, ItemID.prudentium_gemstone, ItemID.prudentium_ingot);

IDRegistry.genItemID("prudentium_chestplate");
Item.createArmorItem("prudentium_chestplate", "Prudentium Chestplate", { name: "prudentium_chestplate", meta: 0 }, { type: "chestplate", armor: 8, durability: 960, texture: "armor/prudentium_layer_0.png" });
MysticalRecipes.addGemstoneUpgrade(ItemID.prudentium_chestplate, ItemID.inferium_chestplate, ItemID.prudentium_gemstone, ItemID.prudentium_ingot);

IDRegistry.genItemID("prudentium_leggings");
Item.createArmorItem("prudentium_leggings", "Prudentium Leggings", { name: "prudentium_leggings", meta: 0 }, { type: "leggings", armor: 7, durability: 900, texture: "armor/prudentium_layer_1.png" });
MysticalRecipes.addGemstoneUpgrade(ItemID.prudentium_leggings, ItemID.inferium_leggings, ItemID.prudentium_gemstone, ItemID.prudentium_ingot);

IDRegistry.genItemID("prudentium_boots");
Item.createArmorItem("prudentium_boots", "Prudentium Boots", { name: "prudentium_boots", meta: 0 }, { type: "boots", armor: 4, durability: 780, texture: "armor/prudentium_layer_0.png" });
...
Callback.addCallback("ServerPlayerTick", function(playerUid) {
	if (World.getThreadTime() % 5 == playerUid % 5) {
		let region = BlockSource.getDefaultForActor(playerUid);
		if (region != null) {
			let position = Entity.getPosition(playerUid);
			if (region.getBlockId(position.x - 0.5, position.y - 0.8, position.z - 0.6) == BlockID.hexibiscus) {
				Entity.addEffect(playerUid, Native.PotionEffect.absorption, 0, 100);
				Entity.addEffect(playerUid, Native.PotionEffect.regeneration, 0, 100);
			}
		}
			...
			if ((helmet == ItemID.prudentium_helmet && chestplate == ItemID.prudentium_chestplate) ||
				...
				if ((chestplate == ItemID.prudentium_chestplate && leggings == ItemID.prudentium_leggings) ||
					...
					if ((leggings == ItemID.prudentium_leggings && boots == ItemID.prudentium_boots) ||
						...
						if (equipped != MysticalArmorBuffType.equipped) {
							...
							MysticalArmorBuffType.equipped = equipped;
						}
						switch (equipped) {
